...
object GaugeManualTest extends SimpleSwingApplication with Logging {
  ...
  val frame = new MainFrame {
    ...
    contents = new GaugeTestPanel({
      val comp = new GaugeComponent with SvgElevationGauge //SvgDistanceGauge //SvgPowerGauge //SvgHeartRateGauge // IconicHeartRateGauge //RadialSpeedGauge // ElevationChart
      comp match {
